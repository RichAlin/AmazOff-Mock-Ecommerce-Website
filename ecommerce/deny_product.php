...
<div id = "container">
    ...
    <div id = "content">
        ...
        $q = "UPDATE product SET approved = '0' WHERE id = '$id'";
        ...
        <center><table>
                <tr>
                    <th style = "border: 1px solid #52c4a5; text-size: 18px; padding: 10px; text-align:center"> Item Has Been Denied </th>
                ...
                $message = "Item ".$row['name']." has been denied by admin.";
