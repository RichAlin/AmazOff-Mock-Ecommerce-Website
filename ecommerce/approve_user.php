...
<div id = "container">
    ...
    <div id = "content">
        ...
        $q = "UPDATE eusers SET approved = '1' WHERE uname = '$uname'";
        $r = mysqli_query($dbc,$q);
        
        if($r){
        $message = $uname. ', you have been approved to access AmazOff. Enjoy!';
        ...
        echo'<center><table>
                <tr>
                    <th style = "border: 1px solid #52c4a5; text-size: 18px; padding: 10px; text-align:center"> User Has Been Approved </th>
